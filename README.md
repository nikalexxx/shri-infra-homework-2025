...
3. Флоу фикса к релизу, который запускается вручную:
    ...
    - принимает на вход версию релиза и все действия выполняет в ветке этого релиза (необходимо выбрать ветку с релизом!)
...
4. Флоу выкатки релиза в прод
    ...
    - принимает на вход версию релиза (необходимо выбрать ветку с релизом!)
